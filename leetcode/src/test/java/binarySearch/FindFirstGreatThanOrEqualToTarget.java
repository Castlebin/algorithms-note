...
public class FindFirstGreatThanOrEqualToTarget {
    ...
    public int findFirstGreatThanOrEqualToTargetPos(int[] nums, int target) {
        int left = 0;
    ...
    public void test() {
        for (int testCount = 0; testCount < 10; testCount++) {
            ...
            int binarySearchResult = findFirstGreatThanOrEqualToTargetPos(nums, target);
